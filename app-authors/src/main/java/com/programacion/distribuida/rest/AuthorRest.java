...
public class AuthorRest {
    ...
    @POST
    @Operation(summary = "Nuevo author", description = "Crear nuevo author")
    ...
    @PUT
    @Path("/{id}")
    @Operation(summary = "Actualiza author", description = "Actualizar autor por id")
    ...
    @DELETE
    @Path("/{id}")
    @Operation(summary = "Elimina author", description = "Eliminar author por id")
    @APIResponse(responseCode = "204", description = "NO CONTENT")
